 ...
 */
func countNameCharacters() {
    let name: String = "Madina"
    print("My name have \(name.characters.count) characters in it.")
}
countNameCharacters()
 ...
 */
func separateElements(num1: Int, num2: Int) {
    let sum = num1 + num2
    print(sum)
